...
export function BlogPostPageClient({ postData }: BlogPostPageClientProps) {
  const { title, date, readTime, slug, tags, image, contentHtml } = postData

  return (
    <div className="container py-12 relative">
      {/* Floating share button - client component */}
      <FloatingShareButton title={title} url={`https://mgiovani.com/blog/${slug}`} />
